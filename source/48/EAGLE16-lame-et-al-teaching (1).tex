...
\address[ilc]{Centre Camille Jullian, MMSH, CNRS and Laboratorio di Cultura Digitale, University of Pisa}
...
\cortext[first]{Corresponding author. Email: mlame@mmsh.univ-aix.fr. The poster pertaining to this article can be viewed in the \emph{poster} section of the academic blog \emph{Épigraphie En Réseau} -  \url{http://eer.hypotheses.org}.}
...
We wish to acknowledge the research assistance of T. M. Crandall,
...
\nocite{cherry_storytelling_2014}
\bibliographystyle{sapauth-eng}
\bibliography{../../EAGLE}

%SOSTITUIRE, PRIMA DI MANDARE, CON LA RIGA \bibliography{../../EAGLE}
