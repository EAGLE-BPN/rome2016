...
Given the template described in Part III, and ANNEX II of the EAGLE Metadata Schema (\citet{sicilia_eagle_2015}), an XSL Transformation converts from string epigraphic texts in marked up TEI-EPIDOC XML, following the \href{http://www.stoa.org/epidoc/gl/dev/}{EpiDoc guidelines} (\citet{Elliott2007}).
